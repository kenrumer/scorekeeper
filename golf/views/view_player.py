...
def loadPlayers(request):
    ...
    """
    clubs = list(Club.objects.values('id', 'name', 'logo', 'player_plugin__class_module', 'player_plugin__class_name', 'data'))
    for club in clubs:
        classModule = importlib.import_module('golf.playerplugins.'+club['player_plugin__class_module'])
