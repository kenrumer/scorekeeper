...
class FormatBase(object):
    ...
    def mergePlayerResults(self, tournament_id, new_player_results_list):
        try:
            resultList = list(Score.objects.filter(round__tournament__id=tournament_id).values('score', 'score_style', 'score_net', 'score_net_style', 'round__handicap_index', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__', 'round__net_style'))
