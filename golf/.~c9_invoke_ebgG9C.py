...
class TournamentRound(models.Model):
    ...
    tournament_round_date_scheduled = modelsForeignKey('TournamentRoundDateScheduled', verbose_name='Tournament Round Date Scheduled', null=True, blank=True, help_text='Date this round of the tournament was supposed to be played')
