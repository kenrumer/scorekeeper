...
class TournamentRound(models.Model):
    ...
    date_finished = models.DateField(verbose_name='Date Finished', null=True, blank=True, help_text='Select the date finished (rarely different than schedule)for this tournament')
