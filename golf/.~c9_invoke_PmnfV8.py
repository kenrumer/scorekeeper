...
class PayoutPlugin(models.Model):
    ...
    tournament_round_date_scheduled = models.ForeignKey('TournamentRoundDateScheduled', verbose_name='Tournament and Date', on_delete=models.SET_NULL, null=True, blank=True)
    """
