...
class Tournament(models.Model):
    ...
    format_plugin = models.ForeignKey('TournamentFormatPlugin', verbose_name='Format', on_delete=models.SET_NULL, null=True, blank=True, help_text='Select the tournament format')
    def __str__(self):
        """
