...
class TournamentRound(models.Model):
    ...
    tournament_round_date_scheduled = ForeignKey('TournamentRoundDateScheduled', verbose_name='Tournament Round Date Scheduled', null=True, blank=True, help_text='Date t)
