...
class FormatBase(object):
    ...
    def mergePlayerResults(self, tournament_id, new_player_results_list):
        try:
            resultList = list(Score.objects.filter(round__tournament__id=tournament_id).values('score', 'score_style', 'score_net', 'score_net_style', 'round__handicap_index', 'round__', 'round__', 'round__', 'round__', 'round__total_out_net_style', 'round__total_in', 'round__total_in_style', 'round__total_in_net', 'round__total_in_net_style', 'round__total', 'round__total_style', 'round__net', 'round__net_style'))
