...
class Round(models.Model):
    ...
    tournament_round_date_scheduled = models.ForeignKey(TournamentRoundDateScheduled, null=True, blank=True, verbose_name='Enter the tournament date for the scorecard')
